...
namespace ModBusDevExpress.Models
{
    public class ModbusDeviceSettings
    {
        ...
        public int Interval { get; set; }        // 🎯 수집 주기 (초)
        public int SaveInterval { get; set; }    // 🎯 저장 주기 (초) - 활용
    ...
    public class MemoryMapping
    {
        ...
        public string DataType { get; set; } // B, W, F
        public string Format { get; set; } // 1, F2, etc
    }
}